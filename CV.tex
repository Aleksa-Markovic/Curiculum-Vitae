...
\begin{document}
	...
	\subsection{\large{Power Lever Kragujevac - Mid-level Engineer}}
	\subsubsection{\large{Date:}\normalsize{ 08.2022. - 03.2023.}}
	\subsubsection{\large{Worked on:}\normalsize{ Making GUI applications for In-House apps  and web-apps, back-end Javascript development on Knack, extraction of requested client data.
